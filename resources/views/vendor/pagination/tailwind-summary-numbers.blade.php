{{--
    Laravel pagination partial: “Showing A to B of C” plus prev/next icons and page numbers.
    Used together with pagination::simple-tailwind so we do not repeat the mobile-only row from the default Tailwind view.
--}}
@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="w-full">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            {{-- How many items you are looking at out of the total. --}}
            <div class="shrink-0">
            ...
            {{-- Page controls: swipe sideways on narrow screens if there are many pages. --}}
